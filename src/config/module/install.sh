...
mse_module_onInstall() {
  ...
  if [ -f "${mseConfigFilePath}" ]; then
    ...
    mseControlVariables+="MSE_MD_PROMPT_SELECTED_STYLE_NAME=\"NEWLINE_MINIMAL\"\n"
    ...
    mseControlVariables+="MSE_MD_PROMPT_SELECTED_PH_COLOR[\"AT_SIGN\"]=\"4 NONE NONE LBLUE\"\n"
    mseControlVariables+="MSE_MD_PROMPT_SELECTED_PH_COLOR[\"HOSTNAME_SHORT\"]=\"4 NONE NONE DWHITE\"\n"
    mseControlVariables+="MSE_MD_PROMPT_SELECTED_PH_COLOR[\"ZCOLOR_01\"]=\"4 NONE NONE LBLUE\"\n"
